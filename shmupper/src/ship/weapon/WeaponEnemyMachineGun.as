package ship.weapon {
	...
	public class WeaponEnemyMachineGun extends Weapon {
		//private var pc:IParticleContainer;
		private var speed:Number = 5;
		private var position:Number;
		public function WeaponEnemyMachineGun(x:Number = 0, y:Number = 0, angle:Number = 0, delay:Number = NaN, speed:Number = NaN):void {
			super(delay);
		...
		*/
		...
		override public function shoot():void {
			if (!cooling) {
				...
				var b:Bullet = new Bullet(spawnPoint, offsetPoint.subtract(spawnPoint));
